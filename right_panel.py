...
class RightPanel:
    def __init__(self, parent):
        ...
        self.sheet = Sheet(self.right_panel, data=data, header=headers, width=600, height=400)
...
class RightPanel:
    def __init__(self, parent):
        ...
        # Create tksheet table
        self.sheet = Sheet(self.right_panel, data=data, headers=self.custom_headers, width=600, height=400)
        self.sheet.pack(fill="both", expand=True)
    ...
    def load_from_pickle(self):
        ...
        if os.path.exists(PICKLE_FILE):
            ...
            # Default empty table data
            data = [["" for _ in self.custom_headers] for _ in range(10)]
        return data
